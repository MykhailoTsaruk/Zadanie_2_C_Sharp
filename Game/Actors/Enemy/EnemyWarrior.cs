...
{
    public class EnemyWarrior : AbstractCharacter
    {
        ...
        private int iteration = 120;

        public EnemyWarrior(Animation animationHold, Animation animationRun,
        ...
        public override void Update()
        {
            if (player == null)
            {
                ...
                if (GetName() == "OrcWarrior")
                {
                    GetWorld().AddActor(new HandsWarriorOrc(this));
                }
                else if (GetName() == "SkeletonWarrior")
                {
                    GetWorld().AddActor(new HandsWarriorSkeleton(this));
                }
            }
            if (!die)
            {
                ...
                if (healthPoint <= 0)
                {
                    ...
                    if (GetName() == "SkeletonWarrior")
                    {
                        SetPosition(GetX(), GetY() - 14);
