...
{
    public class EnemyShaman : AbstractCharacter
    {
        ...
        public EnemyShaman(Animation animationHold, Animation animationRun,
        ...
        public override void Update()
        {
            if (player == null)
            {
                ...
                if (GetName() == "OrcShaman")
                {
                    GetWorld().AddActor(new HandsShamanOrc(this));
                }
                else if (GetName() == "SkeletonShaman")
                {
                    GetWorld().AddActor(new HandsShamanSkeleton(this));
                }
            }
            if (!die)
            {
                ...
                if (healthPoint <= 0)
                {
                    ...
                    if (GetName() == "SkeletonShaman")
                    {
                        SetPosition(GetX(), GetY() - 24);
