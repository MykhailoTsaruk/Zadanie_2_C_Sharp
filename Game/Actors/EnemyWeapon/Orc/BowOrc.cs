...
{
    public class BowOrc : AbstractCharacter
    {
        private HandsArcherOrc hands;
        ...
        public BowOrc(HandsArcherOrc hands)
        {
            this.hands = hands;
            animationBow = new Animation("resources/sprites/Weapon/Orc/Bow.png", 16, 24);
        ...
        public override void Update()
        {
            ...
            if (GetShot())
            {
                ...
                {
                    GetWorld().AddActor(new ArrowOrc(this));
                    GetAnimation().Stop();
