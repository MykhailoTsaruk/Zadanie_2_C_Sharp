...
{
    public class BigSwordOrc : AbstractCharacter
    {
        ...
        public BigSwordOrc(HandsWarriorOrc hands)
        {
            this.hands = hands;
            animation = new Animation("resources/sprites/Weapon/Orc/BigSword.png", 33, 33);
        ...
        public override void Update()
        {
            ...
            if (hands.IsLeft())
            {
                ...
                SetPosition(hands.GetX() - 21, hands.GetY() - 20);
            }
            else
            {
                if (lastDirection != hands.IsLeft())
