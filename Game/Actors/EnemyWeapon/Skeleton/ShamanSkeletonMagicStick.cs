...
{
    public class ShamanSkeletonMagicStick : AbstractCharacter
    {
        private HandsShamanSkeleton hands;
        ...
        public ShamanSkeletonMagicStick(HandsShamanSkeleton hands)
        {
            this.hands = hands;
            animation = new Animation("resources/sprites/Weapon/Skeleton/ShamanSkeletonMagicStick.png", 26, 26);
        ...
        public override void Update()
        {
            ...
            if (hands.IsLeft())
            {
                ...
                SetPosition(hands.GetX() - 12, hands.GetY() - 14);
            }
            else
            {
                if (isLeft != hands.IsLeft())
                ...
                SetPosition(hands.GetX() + 20, hands.GetY() - 14);
            }
            if (hands.GetShot())
            {
                if (wait == 0 & !shot)
